            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>This Site is Developed by <span> M B Raghav </span> as a task of GRIPJULY2021 Internship Program by The Sparks Foundation</p>
                    ...
                    <form action="transfer.php" method="POST">
                        <div class="row">
                            ...
                            <select name=reciever id="dropdown" class="form-select form-select-sm col col-sm-2"  style="width: 20%;">
                                ...
                                <?php
                                    $db = mysqli_connect("localhost", "root", "", "user_table");
